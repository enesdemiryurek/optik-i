          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="lg:col-span-5 flex flex-col justify-center">
              ...
              <div className="flex flex-col gap-4 mb-10 max-w-lg">
                <a href="tel:+905468005269" className="btn-primary w-full text-center py-5 text-sm shadow-md hover:shadow-xl transition-shadow flex items-center justify-center gap-2">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                  Telefon İle Bilgi Al
                </a>
                <a
                  href={`https://wa.me/905468005269?text=${encodeURIComponent('Merhaba, ' + product.brand + ' ' + product.model + ' modeli hakkında bilgi almak istiyorum. Ürün Linki: https://caddeoptikbatikent.com/urunler/detay?id=' + product.id)}`}
                  target="_blank"
