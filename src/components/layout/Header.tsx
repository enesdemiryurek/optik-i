      ...
      <div className="page-container max-w-[1440px]">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="https://wa.me/905468005269" target="_blank" rel="noopener noreferrer" className={`hidden lg:flex items-center gap-2 px-5 py-2.5 rounded-full font-bold text-xs tracking-wider transition-all duration-300 ${isTransparent && isLightHero ? 'bg-black/5 text-black hover:bg-[#25D366] hover:text-white' : isTransparent ? 'bg-white/10 text-white hover:bg-[#25D366]' : 'bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white'}`}>
          ...
          >
            ...
            >
              ...
              <div className="p-8 bg-gray-50 border-t border-gray-100 flex flex-col gap-6">
                <a href="https://wa.me/905468005269" target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white py-4 px-6 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-lg hover:scale-[1.02] transition-transform">
